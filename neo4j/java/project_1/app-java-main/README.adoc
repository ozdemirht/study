...
|People | node (entity) represents an actor or a director in movies. Node properties contain birth year. Director and Actors are possible labels.
...
Properties of relationship contain role. A person can act in multiple movies.
...
because a person can be actor and director and
